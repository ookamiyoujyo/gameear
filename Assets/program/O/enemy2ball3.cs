...
public class enemy2ball3 : MonoBehaviour
{
    ...
    private List<TamaTobasu3> list = new List<TamaTobasu3>();
    /*追記終わり*/
    ...
    void Update()
    {
        ...
        if (!hasMakeTama)
        {
            ...
            var pos = gameObject.transform.position + new Vector3(cos * 2.0f, sin * 2.0f, sin * 2.0f * -1);
            var t = Instantiate(tama) as GameObject;
            t.transform.position = pos;
            /*追記*/
            //弾オブジェクトtからTamaTobasuコンポネントを取得               
            var a = t.GetComponent<TamaTobasu3>();
